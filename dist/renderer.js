...
export function drawGameObject(ctx, kind, x, y, w, h) {
    if (kind === "gun") {
...
export function drawScore(ctx, points, x, y) {
    ctx.save();
...
function drawGunIcon(ctx, x, y, w, h) {
...
function drawBirdIcon(ctx, x, y, w, h) {
